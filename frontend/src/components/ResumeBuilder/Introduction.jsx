...
import cvLogo from './../../Assets/cvLogo.jpeg'
import { Image } from '@chakra-ui/react'
import { useContext } from 'react';
import ResumeContext from './Context/ResumeContext';
import ThemeTemplateData from './ThemeTemplateData';
        ...
        <>
            ...
            <Container my={{ base: 1.5, md: 16 }} justifyContent={'space-between'} flexDirection={{ base: 'column', md: 'row', sm: 'column' }} display={'flex'} alignItems={'center'} maxW={'7xl'}>
...

                {
                    selectBtn ?
                        <Stack>
                           <Image src={cvLogo} alt='home logo' width="500px" height="550px" my="4" />
