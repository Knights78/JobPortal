...
const PostJob = () => {
    ...
    // const{singleAdminJob}=useSelector(store=>store.job)
    ...
    const selectChangeHandler=(value)=>{
        const selectedCompany=companys.find((company)=>company.name.toLowerCase() === value)
  ...
  return (
    ...
    <div className='flex items-center justify-center w-screen my-5'>
        <form onSubmit = {submitHandler} className='p-8 max-w-4xl border border-gray-200 shadow-lg rounded-md'>
            ...
            {
                companys.length === 0 && <p className='text-xs text-red-600 font-bold text-center my-3'><Button  onClick={() => navigate("/admin/jobs/create")}>*Please register a company first, before posting a jobs</Button></p>
            }
        </form>
    </div>
</div>
