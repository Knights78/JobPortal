        ...
        <div>
            ...
            <div className='flex items-center justify-center max-w-7xl mx-auto'>
                <form onSubmit={submitHandler} className='w-1/2 border border-gray-200 rounded-md p-4 my-10'>
                    ...
                    <div className='flex items-center justify-between'>
                        <RadioGroup className="flex items-center gap-4 my-5 ">
                            <div className="flex items-center space-x-2">
                                ...
                                />
                                <Label className='text-lg'htmlFor="r1">Student</Label>
                            </div>
                            <div className="flex items-center space-x-2">
                                <Input
                                    type="radio"
                                    ...
                                    className="cursor-pointer text-lg"
                                />
                                <Label className='text-lg' htmlFor="r2">Recruiter</Label>
                            </div>
                        </RadioGroup>
                    ...
                    <span className='text-md'>Already have an account? <Link to="/login" className='text-blue-600 text-md'>Login</Link></span>
                </form>
            </div>
        </div>
    )
